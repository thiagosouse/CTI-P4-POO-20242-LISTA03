...
public class Principal {
	public static void main(String args[]) {
		...
		float tot_geral, tot_vend, comissao, maior;
		
		float qtd[] = new float[10];
		...
		for (i = 0; i < 10; i++) {
			...
			System.out.println("Quandidade vendida do " + (i + 1) + "o produto: " + qtd[i] + "|"+" Valor do " + +(i + 1)
					+ "o produto: " + preco[i] + "|"+" Total geral da venda: " + tot_vend);
